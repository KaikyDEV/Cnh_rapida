...
import { Home, GraduationCap, Car, User, LogOut, FileText, ShieldAlert, LayoutDashboard, Building2, Calendar } from 'lucide-react';
...
export default function Sidebar() {
    ...
    // Definir links por role
    const links = [
        { href: '/home', label: 'Início', icon: LayoutDashboard, roles: ['Admin'] },
        { href: '/aluno', label: 'Painel Aluno', icon: LayoutDashboard, roles: ['Aluno'] },
        { href: '/instrutor', label: 'Painel Instrutor', icon: LayoutDashboard, roles: ['Instrutor'] },
        { href: '/auto-escola', label: 'Unidade Escola', icon: Building2, roles: ['AutoEscola'] },
        
        { href: '/documentos', label: 'Meus Documentos', icon: FileText, roles: ['Aluno', 'Instrutor', 'AutoEscola'] },
        { href: '/admin/documentos', label: 'Aprovar Documentos', icon: GraduationCap, roles: ['Admin'] },

        { href: '/agendamento', label: 'Aulas Práticas', icon: Calendar, roles: ['Aluno', 'Instrutor', 'AutoEscola'] },
        { href: '/perfil', label: 'Meu Perfil', icon: User, roles: ['Aluno', 'Instrutor', 'AutoEscola'] },
    ];
